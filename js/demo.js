 ...
 */
{
    ...
    class Item {
		constructor(el, options) {
            ...
            this.DOM.animatable = {};
            this.DOM.animatable.image = this.DOM.el.querySelector('.cwibox__img');
            this.DOM.animatable.title = this.DOM.el.querySelector('.cwibox__title');
            this.DOM.animatable.text = this.DOM.el.querySelector('.cwibox__text');
            this.DOM.animatable.deco = this.DOM.el.querySelector('.cwibox__deco');
            this.DOM.animatable.shadow = this.DOM.el.querySelector('.cwibox__shadow');
            this.DOM.animatable.content = this.DOM.el.querySelector('.cwibox__content');
    ...
    class Overlay {
        constructor() {
            this.DOM = {el: document.querySelector('.cwi__overlay')};
            this.DOM.reveal = this.DOM.el.querySelector('.cwi__overlay__reveal');
            this.DOM.items = this.DOM.el.querySelectorAll('.cwi__overlay__item');
            this.DOM.close = this.DOM.el.querySelector('.cwi__overlay__close');
        }
        show(contentItem) {
            this.contentItem = contentItem;
            this.DOM.el.classList.add('cwi__overlay--open');
            // show revealer
        ...
        revealItem() {
            ...
            let itemElems = [];
            itemElems.push(this.contentItem.querySelector('.cwibox__shadow'));
            itemElems.push(this.contentItem.querySelector('.cwibox__img'));
            itemElems.push(this.contentItem.querySelector('.cwibox__title'));
            itemElems.push(this.contentItem.querySelector('.cwibox__text'));
            itemElems.push(this.contentItem.querySelector('.cwibox__deco'));
            itemElems.push(this.contentItem.querySelector('.cwi__overlay__content'));
        ...
        hide() {
            this.DOM.el.classList.remove('cwi__overlay--open');
    ...
    class Grid {
        constructor(el) {
            this.DOM = {el: el};
            this.items = [];
            Array.from(this.DOM.el.querySelectorAll('a.cwigrid__item')).forEach((item) => {
                const itemObj = new Item(item);
                this.items.push(itemObj);
                if ( !item.classList.contains('cwigrid__item--noclick') ) {
    ...
    let allowTilt = true;
    new Grid(document.querySelector('.cwigrid'));

    // Preload all the images in the page..
    imagesLoaded(document.querySelectorAll('.cwibox__img'), () => document.body.classList.remove('loading'));
}
